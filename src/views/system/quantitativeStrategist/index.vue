  ...
  <div class="app-container">
    <el-card shadow="never" class="table-wrapper" v-loading="table.loading.value">
      ...
      <el-table :data="table.list.value" row-key="id" @selection-change="table.selectionChangeHandler($event)">
        ...
        <el-table-column prop="level" :label="$t('dengJi_0')" min-width="60" />
        <el-table-column prop="sort" :label="$t('paiXu')" width="100" />
        <el-table-column prop="title_original" :label="$t('biaoTi')" min-width="220" />
        <el-table-column prop="subtitle_original" :label="$t('fuBiaoTi')" min-width="220" />
        ...
        <!-- <el-table-column prop="push_time" label="新增时间" width="200"></el-table-column> -->
...
import api, { type Form, Query } from "@/api/system/quantitativeStrategist";
