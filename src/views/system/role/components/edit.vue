<template>
  <el-dialog v-model="visible" :title="title" width="600px" @closed="closeHandler">
    <el-form ref="formRef" :model="formData" :rules="rules" label-width="200px">
      <el-form-item :label="$t('jiaoSeMingCheng_0')" prop="title">
        <el-input v-model="formData.title" :placeholder="$t('qingShuRuJiaoSeMing')" />
      </el-form-item>
      <el-form-item :label="$t('jiaoSeBianMa_0')" prop="name">
        <el-input v-model="formData.name" :placeholder="$t('qingShuRuJiaoSeBian')" />
      </el-form-item>
...
const rules = {
  title: [{ required: true, message: $t("qingShuRuJiaoSeMing"), trigger: "blur" }],
  name: [{ required: true, message: $t("qingShuRuJiaoSeBian"), trigger: "blur" }],
  dataScope: [{ required: true, message: $t("qingXuanZeShuJuQuan"), trigger: "blur" }],
