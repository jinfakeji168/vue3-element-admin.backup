  ...
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-wrapper" v-loading="table.loading.value">
      ...
      <el-table :data="table.list.value" row-key="id" @selection-change="table.selectionChangeHandler($event)">
        ...
        <el-table-column :label="$t('jiaoSeMingCheng')" prop="title" min-width="100" />
        <el-table-column :label="$t('jiaoSeBianMa')" prop="name" width="150" />

        <el-table-column :label="$t('zhuangTai')" align="center" width="100">
          <template #default="scope">
            <el-tag v-if="scope.row.status === StatusEnum.False" type="success">{{ $t("zhengChang") }}</el-tag>
  ...
  formItem: [
    {
      type: "input",
      modelKey: "title",
      label: $t("jiaoSeMingCheng_0"),
      props: {
        placeholder: $t("qingShuRuJiaoSeMing"),
        clearable: true,
        style: { width: "200px" },
      },
    },
    {
      type: "input",
      modelKey: "name",
      label: $t("jiaoSeBianMa_0"),
      props: {
        placeholder: $t("qingShuRuJiaoSeBian"),
        clearable: true,
        style: { width: "200px" },
      },
    },
